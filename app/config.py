...
class Settings(BaseSettings):
    ...
    PHONE_RELAY_FLEET_BLOCK_THRESHOLD: int = 2
    PHONE_RELAY_FLEET_BLOCK_WINDOW_MS: int = 300000
    PHONE_RELAY_FLEET_COOLDOWN_MS: int = 300000
    PHONE_RELAY_FLEET_ESCALATION_WINDOW_MS: int = 3600000
    PHONE_RELAY_FLEET_ESCALATED_COOLDOWN_MS: int = 5400000
